...
const sampleNotices = [
  { id: "cash-dividend", name: "aurora-cash-dividend.pdf", type: "Cash dividend", classification: "Mandatory", source: "Synthetic custodian portal", summary: "EUR 0.42 gross per share · record date 24 Aug 2026", risk: "Term validation", pdf: false },
  { id: "rights-issue", name: "rights-issue-notice.pdf", type: "Rights issue", classification: "Voluntary", source: "Synthetic custodian portal", summary: "1 new share for 5 rights · EUR 8.50 subscription · default: lapse", risk: "Election and approval", pdf: true },
  { id: "stock-split", name: "delta-stock-split.pdf", type: "Stock split", classification: "Mandatory", source: "Synthetic agent feed", summary: "4-for-1 split · fractional entitlement rounded down", risk: "Fractional entitlement", pdf: false },
  { id: "bonus-issue", name: "nimbus-bonus-issue.pdf", type: "Bonus issue", classification: "Mandatory", source: "Synthetic custodian portal", summary: "1 bonus share for every 10 eligible shares", risk: "Position match", pdf: false },
  { id: "tender-offer", name: "meridian-tender-offer.pdf", type: "Tender offer", classification: "Voluntary", source: "Synthetic agent feed", summary: "Cash tender with capped acceptance and client election", risk: "Election capacity", pdf: false },
  { id: "merger", name: "verdant-merger-election.pdf", type: "Merger", classification: "Voluntary", source: "Synthetic custodian portal", summary: "Cash and share election with deadline controls", risk: "Checker approval", pdf: false },
];
        ...
        <aside className="space-y-5">
          <Card className="border-primary/30">
            <CardHeader className="border-b bg-slate-50/70">
              ...
              <CardDescription>Preview the selected synthetic sample before creating a case.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4 p-5">
              ...
              {selected.pdf ? (
                <div className="overflow-hidden rounded-md border bg-slate-100">
                  <iframe title="Synthetic rights issue PDF" src={demoPdfPath} className="h-52 w-full bg-white" />
                  <a className="block border-t bg-white p-2" href={demoPdfPath} target="_blank" rel="noreferrer">
                    <Button variant="ghost" size="sm" className="w-full"><ExternalLink className="mr-2 h-3.5 w-3.5" />Open three-page PDF</Button>
                  </a>
                </div>
              ) : (
                <div className="rounded-md border border-dashed bg-slate-50 p-4 text-sm text-slate-600">
                  <p className="font-medium text-slate-800">Structured sample preview</p>
                  <p className="mt-1 text-xs leading-5">This POC provides a detailed PDF viewer for the rights-issue sample only. This selected notice remains an explicit synthetic scenario, not a parsed upload.</p>
                </div>
              )}
              ...
              <Button className="w-full" onClick={submit} disabled={createIntake.isPending}>
                {createIntake.isPending ? "Creating case…" : "Create case for review"}
              </Button>
            </CardContent>
          </Card>
          <Card>
