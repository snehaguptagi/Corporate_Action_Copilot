...
- [Real intake portfolio analysis](real-intake-portfolio-analysis.md) — Real notices match a static holdings master (ISIN before name aliases); custodian merges must carry calculation inputs forward.
